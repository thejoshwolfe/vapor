(function() {
  ...
  function Man() {
    ...
    this.ground_fringe_sensor = null;
  ...
  Man.prototype.standing_half_width = 0.8 / 2;
  Man.prototype.crawling_half_width = 91/32 / 2;
  ...
  Man.prototype.get_half_width = function() {
    if (this.posture === Man.POSTURE_STANDING)  return this.standing_half_width;
    if (this.posture === Man.POSTURE_CROUCHING) return this.standing_half_width;
    if (this.posture === Man.POSTURE_CRAWLING)  return this.crawling_half_width;
    throw asdf;
  };
  ...
  Man.prototype.get_torso_shape = function() {
    return b2PolygonShape.AsBox(this.get_half_width(), this.get_half_height());
  };
  Man.prototype.get_ground_sensor_shape_with_half_width = function(half_width) {
    var center = new b2Vec2(0, this.gravity_direction * this.get_half_height());
    return b2PolygonShape.AsOrientedBox(half_width, this.ground_sensor_height, center);
  };
  Man.prototype.get_ground_sensor_shape = function() {
    return this.get_ground_sensor_shape_with_half_width(this.standing_half_width * 0.95);
  };
  Man.prototype.get_ground_fringe_sensor_shape = function() {
    return this.get_ground_sensor_shape_with_half_width(this.get_half_width() * 0.995);
  };
  ...
  Man.prototype.update_ground_sensor_shape = function() {
    this.ground_sensor.m_shape = this.get_ground_sensor_shape();
    this.ground_fringe_sensor.m_shape = this.get_ground_fringe_sensor_shape();
    this.reset_mass();
  };
})();
